...
-- example	
	...
	--Correct querry to finding the wmployees who's salary is greater then average salary?
	
	select employeeid, firstname, lastname, salary from employees A
	where salary >
	(select avg(salary) as Average_salary from employees B)
